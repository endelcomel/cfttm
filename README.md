...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cfttm
```

A live public deployment of this template is available at [https://cfttm.templates.workers.dev](https://cfttm.templates.workers.dev)
